...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('names', models.CharField(max_length=255, verbose_name='Nombres de los modulos')),
            ],
            options={
                'verbose_name': 'Modulo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True)),
                ('nit', models.CharField(max_length=255, unique=True, verbose_name='Nit de la empresa')),
                ...
                ('module', models.ManyToManyField(related_name='enterprise_module', to='api.Module')),
